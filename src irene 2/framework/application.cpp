...
void Application::Init(void) {
    ...
    if (Lab2) {
        ...
        my_camera->SetPerspective(45, window_width / (float)window_height, 0.01, 100); //60 degrees, aspect ratio, near and far plane
...

{
    ...
    if (Lab2) {
        ...
        case SDLK_n:
            std::cout << "Near plane before update: " << my_camera->near_plane << std::endl;
            my_camera->near_plane = 0.002f;
            std::cout << "Near plane after update: " << my_camera->near_plane << std::endl;

            my_camera->UpdateViewProjectionMatrix();
            break;
