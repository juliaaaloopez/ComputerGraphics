...
void Entity::Update(float seconds_elapsed) {
    ...
    float angular_speed = 2.0f; //choose a speed in radians/second
    Vector3 rotation_axis(1.0f, 0.0f, 0.0f); //define a vector to rotate. in this case it will rotate in the y axis

    model.Rotate(angular_speed * seconds_elapsed, rotation_axis);
